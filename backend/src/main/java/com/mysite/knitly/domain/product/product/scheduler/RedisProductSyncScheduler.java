...
public class RedisProductSyncScheduler {
    ...
    public void initializedRedisData() {
        ...
        try {
            ...
            log.info("[Scheduler] [Redis] Redis 초기 데이터 로딩 완료 - productCount={}, duration={}ms",
    ...
    public void syncPurchaseCountFromDB() {
        ...
        try {
            ...
            long duration = System.currentTimeMillis() - startTime;
            log.info("[Scheduler] [Redis] 정기 동기화 완료 - productCount={}, duration={}ms",
                    allProducts.size(), duration);
